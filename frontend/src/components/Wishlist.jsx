...
function Wishlist() {
  ...
  const currentProducts = wishlistItems.slice(start, start + itemsPerPage);
      ...
      >
        ...
        {wishlistItems.length === 0 ? (<>
             ...
             >
              ...
              fontWeight="bolder"
              >
                 Your Wishlist is empty&nbsp;!!&nbsp;&nbsp; <Text as="span" color="orange.500" cursor="pointer"><Link to='/products'>Explore products..</Link></Text>
              </Text>
             </Box>
        </>) : (<>
          ...
          >
            <Text
              ...
              fontWeight="bolder"
            >
              Product List on your Wishlist </Text>
            <Box
              mt={["3px","3px","3px","5px"]}
              fontSize={["15px", "15px", "15px", "20px"]}
              ml={["8px", "8px", "10px", "10px"]}
              color="red"
            ><FaHeart /></Box>
          </Box>
